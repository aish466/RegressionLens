...
//        //For x = x1
//        // ay2 + by + (c - x1) = 0
//        discriminant = b*b - 4*a*(c - x1);
//        if(discriminant > 0){
//            yFirst = (-b + Math.sqrt(b*b - 4*a*(c-x1)) );
//            if((yFirst > y1) && (yFirst < y2)){
...
//            }
//            
//            ySecond = (-b + Math.sqrt(b*b - 4*a*(c-x1)) );
//            if((ySecond > y1) && (ySecond < y2)){
//                if(yFirst == ySecond){
//                    xIntersectionPoints[0] = x1;
//                    xIntersectionPoints[1] = x2;
//                    return;
//                }
//                xIntersectionPoints[i] = x1;
//                if(i == 1)
...
//        //For x = x2
//        // ay2 + by + (c - x2) = 0
//        discriminant = b*b - 4*a*(c - x2);
//        if(discriminant > 0){
//            yFirst = (-b + Math.sqrt(b*b - 4*a*(c-x2)) );
//            if((yFirst > y1) && (yFirst < y2)){
...
//            }
//            
//            ySecond = (-b + Math.sqrt(b*b - 4*a*(c-x2)) );
//            if((ySecond > y1) && (ySecond < y2)){
//                if(yFirst == ySecond){
//                    xIntersectionPoints[0] = x1;
//                    xIntersectionPoints[1] = x2;
